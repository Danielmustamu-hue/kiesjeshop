...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-sans selection:bg-indigo-100">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-full flex items-center justify-between">
          <div className="flex items-center gap-6 md:gap-12">
            ...
            >
              ...
              <div className="flex flex-col -gap-1">
                <span className="text-lg md:text-xl font-black text-slate-950 tracking-tighter leading-none">
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="flex items-center gap-2 bg-slate-950 text-white px-4 md:px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-indigo-600 transition-all shadow-xl active:scale-95"
            >
              <Cpu className="hidden xs:block w-4 h-4 text-indigo-400" /> Advisor
            </button>
      ...
      <div className="bg-slate-900 py-2 md:py-3 overflow-hidden whitespace-nowrap border-b border-white/5">
        <div className="flex items-center animate-scroll gap-12 text-[8px] md:text-[9px] font-black uppercase tracking-[0.3em]">
        ...
        {currentView === 'home' && (
          <div className="animate-in fade-in duration-1000">
            <div className="grid grid-cols-12 gap-6 md:gap-8 mb-16">
              <div className="col-span-12 lg:col-span-7 intelligence-card p-8 sm:p-12 md:p-24 relative overflow-hidden group border border-slate-100/50">
                <div className="relative z-10">
                  <div className="flex items-center gap-3 text-indigo-600 font-black text-[10px] uppercase tracking-[0.4em] mb-8 md:mb-12">
              ...
              <div className="col-span-12 lg:col-span-5 flex flex-col gap-6 md:gap-8">
                <div className="bg-slate-950 rounded-[2rem] md:rounded-[3.5rem] p-8 md:p-12 flex flex-col items-center justify-center text-center relative overflow-hidden h-[300px] md:h-[360px] shadow-2xl border border-white/5">
                  <div className="bg-indigo-500/10 p-4 md:p-5 rounded-2xl md:rounded-3xl mb-6 md:mb-8 border border-indigo-500/20">
                    <Cpu className="w-8 h-8 md:w-10 md:h-10 text-indigo-400" />
                  </div>
                  <h2 className="text-2xl md:text-3xl font-black text-white mb-3 md:mb-4 tracking-tighter">AI Consultant</h2>
                  <p className="text-slate-400 text-xs md:text-sm font-medium mb-8 md:mb-10 max-w-[240px]">
                    Krijg direct antwoord op jouw specifieke shopping-vraag.
                  </p>
                  <button 
                    onClick={() => setShowAiAdvisor(true)}
                    className="bg-white text-slate-950 w-full py-4 md:py-5 rounded-xl md:rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-indigo-50 transition-all"
                  >
                    Start Chat
                  </button>
                </div>

                <div className="bg-indigo-600 rounded-[2rem] md:rounded-[3.5rem] p-8 md:p-12 flex flex-col justify-between h-[300px] md:h-[360px] text-white shadow-2xl relative overflow-hidden group border border-white/10">
            ...
            <div id="market-pulse" className="py-12 md:py-24">
               <div className="flex items-center gap-4 mb-8 md:mb-10">
                  <div className="h-px flex-grow bg-slate-200"></div>
                  <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 px-4 md:px-6">Market Analysis</span>
                  <div className="h-px flex-grow bg-slate-200"></div>
               </div>
               <MarketPulseDashboard onRefresh={loadMarketData} isLoading={isMarketLoading} />
            </div>

            <div id="compare" className="py-12 md:py-24">
               <div className="mb-10 md:mb-16">
                  <h2 className="text-4xl md:text-5xl font-black text-slate-950 tracking-tighter mb-4">Vergelijk Beste Producten<span className="text-indigo-600">.</span></h2>
                  <p className="text-slate-500 font-medium text-lg md:text-xl max-w-xl">Top-tier producten direct geanalyseerd op prijs en levertijd bij bol, Amazon and Coolblue.</p>
               </div>
               <ProductShowcase />
            </div>

            <div id="duel" className="py-12 md:py-24">
               <div className="flex items-center gap-4 mb-8 md:mb-10">
                  <div className="h-px flex-grow bg-slate-200"></div>
                  <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 px-4 md:px-6">Comparison Tool</span>
                  <div className="h-px flex-grow bg-slate-200"></div>
               </div>
               <VersusTool />
            </div>

            <div id="shops-section" className="py-12 md:py-24">
               <div className="mb-10 md:mb-16 text-center">
                  <h2 className="text-4xl md:text-7xl font-black text-slate-950 tracking-tighter mb-4">De Grote 3 Winkels<span className="text-indigo-600">.</span></h2>
                  <p className="text-slate-500 font-medium text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">De giganten van de Benelux vergeleken op service, prijs en betrouwbaarheid.</p>
               </div>
            ...
            <div id="gidsen" className="py-12 md:py-24 bg-white rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-24 border border-slate-100 shadow-sm">
               <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16 gap-8">
                  <div>
                    <h2 className="text-4xl md:text-5xl font-black text-slate-950 tracking-tighter mb-4">Beste Koop 2025<span className="text-indigo-600">.</span></h2>
                    <p className="text-slate-500 font-medium text-lg md:text-xl max-w-xl">Onze redactie heeft de 8 meest complexe categorieën voor je uitgezocht in deze koopgidsen.</p>
                  </div>
                  <a href="/?p=koopgidsen" onClick={(e) => { e.preventDefault(); navigateTo('koopgidsen'); }} className="w-full md:w-auto text-center flex items-center justify-center gap-4 bg-slate-100 text-slate-900 px-8 py-4 md:px-10 md:py-5 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-indigo-600 hover:text-white transition-all">
            ...
            <div id="redactie" className="py-12 md:py-24">
               <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16 gap-8">
                  <div>
                    <h2 className="text-4xl md:text-5xl font-black text-slate-950 tracking-tighter mb-4">Intelligence Feed<span className="text-indigo-600">.</span></h2>
                    <p className="text-slate-500 font-medium text-lg md:text-xl max-w-xl">Diepgaande analyses van de nieuwste tech-trends en winkel-psychologie.</p>
                  </div>
                  <a href="/?p=redactie" onClick={(e) => { e.preventDefault(); navigateTo('redactie'); }} className="w-full md:w-auto text-center flex items-center justify-center gap-4 bg-slate-950 text-white px-8 py-4 md:px-10 md:py-5 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-indigo-600 transition-all">
        ...
        {currentView === 'koopgidsen' && (
          <div className="animate-in fade-in duration-700">
             <div className="mb-12 md:mb-16">
                <h2 className="text-4xl md:text-7xl font-black text-slate-950 tracking-tighter mb-4">Koopgidsen<span className="text-indigo-600">.</span></h2>
                <p className="text-slate-500 font-medium text-lg md:text-xl">8 Specialistische categorieën waar de verschillen tussen shops het grootst zijn.</p>
             </div>
      ...
      {showScrollTop && (
        <button 
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[90] p-4 bg-slate-950 text-white rounded-full shadow-2xl hover:bg-indigo-600 transition-all animate-in fade-in zoom-in"
        >
          <ArrowUp className="w-6 h-6" />
        </button>
      )}

      <footer className="bg-slate-950 text-white pt-16 md:pt-32 pb-12 md:pb-16 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 mb-16 md:mb-24">
            <div className="md:col-span-5">
              <div className="flex items-center gap-3 mb-8 md:mb-10">
                ...
                <span className="text-2xl md:text-3xl font-black tracking-tighter">Kiesjeshop<span className="text-slate-600">.nl</span></span>
              </div>
            ...
            <div className="md:col-span-2">
              <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-indigo-400 mb-6 md:mb-10">Platform</h4>
              <ul className="space-y-4 md:space-y-6 text-slate-400 font-bold text-sm">
            ...
            <div className="md:col-span-2">
              <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-indigo-400 mb-6 md:mb-10">Bedrijf</h4>
              <ul className="space-y-4 md:space-y-6 text-slate-400 font-bold text-sm">
            ...
            <div className="md:col-span-3">
              <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-indigo-400 mb-6 md:mb-10">Juridisch</h4>
              <ul className="space-y-4 md:space-y-6 text-slate-400 font-bold text-sm mb-8 md:mb-12">
                ...
                <li><button onClick={triggerCookieSettings} className="hover:text-white transition-colors flex items-center gap-2"><Cookie className="w-4 h-4 text-indigo-500" /> Cookies</button></li>
              </ul>
              <div className="p-6 bg-white/5 rounded-2xl md:rounded-[2rem] border border-white/10">
          ...
          <div className="pt-8 md:pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-8">
            <p className="text-slate-600 text-[10px] font-black uppercase tracking-[0.5em] text-center md:text-left">
      ...
      {showAiAdvisor && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center md:p-4">
          ...
          <div className="relative w-full md:max-w-5xl h-full md:h-auto md:max-h-[90vh] overflow-hidden md:rounded-[4rem] shadow-2xl border-t md:border border-white/10 bg-slate-950">
             <AiAdvisor />
             <button onClick={() => setShowAiAdvisor(false)} className="absolute top-6 right-6 md:top-10 md:right-10 p-3 md:p-4 bg-white/10 text-white rounded-full hover:bg-white/20 transition-all border border-white/10 z-[110]">
                <X className="w-6 h-6" />
             </button>
          </div>
        </div>
