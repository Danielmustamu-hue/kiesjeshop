  ...
  return (
    ...
    >
      <div className="relative">
        <Cpu className="w-5 h-5 text-indigo-400 group-hover:text-white transition-colors" />
      ...
      <div className="flex flex-col items-start leading-none">
        ...
        <span className="text-[8px] font-bold text-slate-400 group-hover:text-indigo-100 uppercase tracking-widest mt-0.5">Vraag advies</span>
      </div>
    </button>
  );
};
