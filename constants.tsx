...
export const SHOPS: ShopData[] = [
  {
    ...
    logoText: 'bol',
    logoBg: 'bg-blue-600',
    buttonColor: 'bg-blue-800 hover:bg-blue-900 text-white shadow-blue-900/20 hover:shadow-blue-900/40',
  ...
  },
  {
    ...
    logoText: 'Coolblue',
    logoBg: 'bg-[#0090E3]', // Terug naar Coolblue Blauw
    buttonColor: 'bg-orange-500 hover:bg-orange-600 text-white shadow-orange-500/20 hover:shadow-orange-500/40',
  ...
  },
  {
    ...
    logoText: 'amazon',
    logoBg: 'bg-[#232F3E]', 
    buttonColor: 'bg-[#FF9900] hover:bg-[#FFAD33] text-slate-900 shadow-yellow-600/20 hover:shadow-yellow-600/40', 
